...
class StorePlatingChecksheetRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'unique_code_id' => [
                'nullable',
                'string',
                \Illuminate\Validation\Rule::unique('plating_checksheets', 'unique_code_id')->where(function ($query) {
            ...
            'plating_date' => $this->boolean('is_scanned') ? 'nullable|date' : 'required|date',
            'plating_shift' => $this->boolean('is_scanned') ? 'nullable|string' : 'required|string',
    ...
    public function messages(): array
    {
        return [
            ...
            'plating_date.required' => 'Tanggal Plating wajib diisi.',
            'plating_shift.required' => 'Shift Plating wajib dipilih.',
