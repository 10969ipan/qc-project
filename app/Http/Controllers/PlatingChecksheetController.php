...
class PlatingChecksheetController extends Controller
{
    ...
    public function store(StorePlatingChecksheetRequest $request)
    {
        ...
        try {
            ...
            if ($result['checksheet']) {
                ...
                return redirect()->route('plating.index', $request->query())
    ...
    public function update(UpdatePlatingChecksheetRequest $request, $id)
    {
        ...
        try {
            ...
            return redirect()->route('plating.index', $request->query())->with('success', $message);
        } catch (\Exception $e) {
    ...
    public function updateApproval(Request $request, $id)
    {
        ...
        return redirect()->route('plating.index', $request->query())->with('success', 'Status approval Plating berhasil diperbarui.');
    }
    ...
    public function dailyRecap(Request $request)
    {
        ...
        return view('plating.daily_recap', compact('recap', 'inspectorRecap', 'ngRecap', 'startDate', 'endDate', 'plantName', 'plantCode'));
    }
}
