...
Route::middleware(['auth'])->group(function () {
    ...
    Route::middleware(['check_approval_rate'])->group(function () {
        ...
        Route::post('/checksheet/incoming-part/arrival', [IncomingPartController::class, 'storeArrival'])->name('incoming.parts.store_arrival');
        Route::put('/checksheet/incoming-part/arrival/{id}', [IncomingPartController::class, 'updateArrival'])->name('incoming.parts.update_arrival');
        Route::delete('/checksheet/incoming-part/arrival/{id}', [IncomingPartController::class, 'destroyArrival'])->name('incoming.parts.destroy_arrival');
        Route::get('/checksheet/incoming-part/arrivals', [IncomingPartController::class, 'getArrivals'])->name('incoming.parts.arrivals');
        Route::get('/checksheet/incoming-part/arrival-logs', [IncomingPartController::class, 'getArrivalLogs'])->name('incoming.parts.arrival_logs');
    ...
    Route::middleware(['role:admin,supervisor,inspector,kashift,asst_manager,manager,karu_qc,kashift_plating,supervisor_plating,asst_manager_plating,manager_plating,oshef'])->group(function () {
        ...
        Route::get('/report/in-process-checksheets/hidden-items-data', [InProcessChecksheetController::class, 'getHiddenItemsModalData'])->name('in_process.hidden_items_data');
        ...
        Route::get('/report/incoming-export/print', [IncomingExportController::class, 'printView'])->name('incoming.exports.print');
        ...
        Route::post('/incoming-chemical/{id}/reject/{type}', [IncomingChemicalController::class, 'reject'])->name('incoming.chemicals.reject');
                ...
                Route::post('standard-performance-tests/import', [\App\Http\Controllers\StandardPerformanceTestController::class, 'import'])->name('standard-performance-tests.import');
