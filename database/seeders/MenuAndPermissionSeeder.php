                        ...
                        'children' => [
                            ...
                            [
                                ...
                                'children' => [
                                    ...
                                    ['name' => 'Double Tape', 'route' => 'double_tape.create', 'order' => 8],
                                    ['name' => 'Incoming Part', 'route' => 'incoming.parts.create', 'order' => 9],
                                    ['name' => 'Incoming Material', 'route' => 'incoming.materials.create', 'order' => 10],
                                    ['name' => 'Incoming Sub-Part', 'route' => 'incoming.sub_parts.create', 'order' => 11],
                                    ['name' => 'Incoming Export', 'route' => 'incoming.exports.create', 'order' => 12],
                                    ['name' => 'Incoming Chemical', 'route' => 'incoming.chemicals.create', 'order' => 13],
                                ]
                            ],
                            [
                                'name' => 'LAPORAN',
                                ...
                                'children' => [
                                    ...
                                    ['name' => 'Double Tape', 'route' => 'double_tape.index', 'order' => 8],
                                    ['name' => 'Incoming Part', 'route' => 'incoming.parts.index', 'order' => 9],
                                    ['name' => 'Incoming Material', 'route' => 'incoming.materials.index', 'order' => 10],
                                    ['name' => 'Incoming Sub-Part', 'route' => 'incoming.sub_parts.index', 'order' => 11],
                                    ['name' => 'Incoming Export', 'route' => 'incoming.exports.index', 'order' => 12],
                                    ['name' => 'Incoming Chemical', 'route' => 'incoming.chemicals.index', 'order' => 13],
                                ]
                            ],
                        ]
                    ],
