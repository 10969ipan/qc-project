...
return new class extends Migration {
    ...
    {
        Schema::create('incoming_chemicals', function (Blueprint $table) {
            $table->id();
            ...
            $table->decimal('komper_jirigen_kg', 10, 2);
            $table->decimal('sampling_size_jirigen_kg', 10, 2);
    ...
    {
        Schema::dropIfExists('incoming_chemicals');
    }
};
