        ...
        @push('scripts')
            ...
            <script>
                ...
                function renderGauges() {
                    ...
                    console.log('[Gauge Debug] dailyJkt:', dailyJkt);
                    console.log('[Gauge Debug] dailyKrw:', dailyKrw);
                    console.log('[Gauge Debug] dailyTotal:', dailyTotal);
                    console.log('[Gauge Debug] FusionCharts available:', !!window.FusionCharts);
                    console.log('[Gauge Debug] FusionCharts object:', window.FusionCharts);

                    if (dailyJkt && document.getElementById("gauge-jakarta")) {
                        console.log('[Gauge Debug] Rendering gauge-jakarta with rate:', calculateRate(dailyJkt));
                        renderGauge("gauge-jakarta", "Jakarta", calculateRate(dailyJkt));
                    }
                    if (dailyKrw && document.getElementById("gauge-karawang")) {
                        console.log('[Gauge Debug] Rendering gauge-karawang with rate:', calculateRate(dailyKrw));
                    ...
                    if (dailyTotal && document.getElementById("gauge-total")) {
                        ...
                        console.log('[Gauge Debug] Rendering gauge-total with rate:', calculateRate(dailyTotal));
                ...
                function renderGauge(container, label, value) {
                    console.log('[Gauge Debug] renderGauge called for:', container, 'value:', value);
                    if (!window.FusionCharts) {
                        console.error('[Gauge Debug] FusionCharts not available!');
                        return;
                    }
