...
<form action="{{ route('admin.cross_cut_painting.update_approval', $checksheet->id) }}" method="POST">
    @csrf
    @method('PUT')
    ...
    <div class="row">
        ...
        <!-- Level 5: Manager Painting -->
        <div class="form-group col-md-4">
            <label for="manager_plating">Status Manager Painting</label>
