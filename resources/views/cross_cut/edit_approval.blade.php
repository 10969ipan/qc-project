                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select name="karu_qc" id="karu_qc" class="form-control">
                            ...
                            <option value="Rejected" @if($checksheet->karu_qc === 'REJECTED') selected @endif>Rejected
                            </option>
                        </select>
                    </div>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select name="kashift_plating" id="kashift_plating" class="form-control">
                            <option value="Pending" @if(is_null($checksheet->kashift_plating)) selected @endif>Pending
                            </option>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select name="supervisor_plating" id="supervisor_plating" class="form-control">
                            <option value="Pending" @if(is_null($checksheet->supervisor_plating)) selected @endif>Pending
                            </option>
                            ...
                            <option value="Rejected" @if($checksheet->supervisor_plating === 'REJECTED') selected @endif>
                                Rejected</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select name="supervisor_qc" id="supervisor_qc" class="form-control">
                            <option value="Pending" @if(is_null($checksheet->supervisor_qc)) selected @endif>Pending
                            </option>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select name="manager_plating" id="manager_plating" class="form-control">
                            <option value="Pending" @if(is_null($checksheet->manager_plating)) selected @endif>Pending
                            </option>
                    ...
                    <div class="form-group col-md-4">
                        ...
                        <select name="manager_qc" id="manager_qc" class="form-control">
                            ...
                            selected @endif>Approved</option>
                            <option value="Rejected" @if($checksheet->manager_qc === 'REJECTED') selected @endif>Rejected
                            </option>
                        </select>
                    </div>
                </div>
