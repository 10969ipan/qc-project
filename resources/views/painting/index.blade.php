    ...
    <div class="card shadow mb-2">
        <div class="card-header py-2 px-3">
            @if(request('view_mode') === 'verifikasi')
                <h6 class="m-0 font-weight-bold text-dark text-uppercase" style="font-size: 0.80rem;">DATA HASIL VERIFIKASI PAINTING</h6>
            @else
                <h6 class="m-0 font-weight-bold text-dark text-uppercase" style="font-size: 0.80rem;">DATA MASUK PAINTING</h6>
            @endif
        </div>
        <div class="card-body p-2">
            <form action="{{ route('painting.index') }}" method="GET"
                ...
                <div class="d-flex align-items-center" style="gap: 4px; align-self: flex-end; margin-bottom: 8px !important; margin-left: 20px;">
                    ...
                    <a href="{{ route('painting.index', array_merge(['plant' => request('plant')], request('view_mode') ? ['view_mode' => request('view_mode')] : [])) }}"
                ...
                <div class="d-flex align-items-center ml-auto" style="gap: 4px; align-self: flex-end; margin-bottom: 8px !important;">
                    ...
                    <a href="{{ route('painting.print', request()->query()) }}"
                                    ...
                                    <td class="align-middle text-center text-nowrap no-export" style="{{ auth()->user()->role === 'admin' ? 'width: 50px;' : 'min-width: 170px;' }}">
                                        ...
                                        <div class="dropdown d-inline-block">
                                            ...
                                            <div class="dropdown-menu dropdown-menu-right shadow border-0" style="border-radius:8px;min-width:180px;">
                                                ...
                                                @if($showEdit)
                                                    <a href="{{ route('painting.edit', array_merge(['id' => $checksheet->id], request()->all())) }}" class="dropdown-item no-loader btn-edit-modal">
                                                ...
                                                @if($showDel)
                                                    ...
                                                    <form action="{{ route('painting.destroy', array_merge(['id' => $checksheet->id], request()->all())) }}" method="POST" class="d-inline w-100">
                                                        @csrf
                                                        @method('DELETE')
