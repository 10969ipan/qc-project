...
@section('title', 'Rekap Harian Verification Painting')
...
<style>
    ...
    /* Print Styles to match painting/print.blade.php */
    @media print {
        @page {
            size: A4 landscape;
            margin: 10mm;
...
<div class="container-fluid">
    ...
    <div class="d-flex align-items-center justify-content-between mb-3 no-print">
        ...
        <div class="d-flex" style="gap: 10px;">
            ...
            <a href="{{ route('painting.index') }}" class="btn btn-sm btn-secondary shadow-sm rounded-pill px-3">
        ...
        <table class="header-table">
            <tr>
                ...
                <td class="title" style="border-left: none !important; text-align: center;">
                    <div style="font-size: 16px;">REKAP HARIAN VERIFICATION PAINTING</div>
                </td>
            </tr>
        </table>
    ...
    <div class="card shadow-sm mb-4 border-0 rounded-lg overflow-hidden custom-filter-card no-print">
        <div class="card-body py-2">
            <form action="{{ route('painting.daily_recap') }}" method="GET" class="row align-items-center">
                ...
                <div class="col-md-auto">
                    ...
                    <a href="{{ route('painting.daily_recap') }}" class="btn btn-light btn-sm shadow-sm rounded-pill px-3 border ml-1">
