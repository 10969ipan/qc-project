...
@php
    ...
    $docHeader = isset($docHeader) ? $docHeader : \App\Models\GeneralSetting::getDocHeader('painting', $headerPlantCode, [
        'judul'      => 'LAPORAN CHECK SHEET PAINTING',
...
<head>
    <meta charset="UTF-8">
    <title>Laporan Checksheet Painting</title>
    <style>
        @page {
            size: A4 landscape;
            margin: 0;
...
<body>
    ...
    <table class="header-table">
        <tr>
            ...
            <td class="title">{{ $docHeader['judul'] ?? 'LAPORAN CHECK SHEET PAINTING' }}</td>
            <td class="doc-info">
                <table>
    ...
    <table class="table">
        <thead>
            <tr>
                ...
                <th rowspan="2">Painting<br>(Tgl / Shift / Lot)</th>
                <th rowspan="2">Quality<br>(Tgl / Shift)</th>
