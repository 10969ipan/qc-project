<form action="{{ route('painting.update_approval', $checksheet->id) }}" method="POST">
    @csrf
    @method('PUT')
    <div class="modal-header bg-info">
        <h5 class="modal-title font-weight-bold text-white">Approval Checksheet Painting #{{ $checksheet->id }}</h5>
