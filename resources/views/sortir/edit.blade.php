...
@section('content')
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('sortir.update', ['id' => $checksheet->id, 'plant' => request('plant')]) }}"
                method="POST">
                @csrf
                @method('PUT')
                            ...
                            <tr>
                                ...
                                <td class="align-middle">
                                    <div class="row no-gutters mb-1">
                                        ...
                                        <div class="col-8">
                                            <input type="number" class="form-control form-control-sm text-center"
                                                name="total_ok" value="{{ $checksheet->total_ok }}" min="0" required>
                                        </div>
                                    </div>
                                    <div class="row no-gutters">
                                        ...
                                        <div class="col-8">
                                            <input type="number" class="form-control form-control-sm text-center"
                                                name="total_ng" value="{{ $checksheet->total_ng }}" min="0" required>
                                        </div>
                                    </div>
                                </td>
                                ...
                                <td class="align-middle">
                                    ...
                                    <textarea class="form-control" name="remarks"
                                        rows="4">{{ $checksheet->remarks }}</textarea>
                                </td>
                            </tr>
                        </tbody>
                    </table>
