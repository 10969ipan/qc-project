            ...
            function autoAddDimensionDefect() {
                ...
                if (!targetSelect) {
                    ...
                    if (rowCount < 4) {
                        ...
                        // Force it to the first row if limit reached and no empty slot
