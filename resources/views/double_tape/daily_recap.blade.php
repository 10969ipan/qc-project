...
@section('title', 'Rekap Harian Verification Double Tape')
...
<style>
    ...
    /* Print Styles to match double_tape/print.blade.php */
    @media print {
        @page {
            size: A4 landscape;
            margin: 10mm;
...
<div class="container-fluid">
    ...
    <div class="d-flex align-items-center justify-content-between mb-3 no-print">
        ...
        <div class="d-flex" style="gap: 10px;">
            ...
            <a href="{{ route('double_tape.index') }}" class="btn btn-sm btn-secondary shadow-sm rounded-pill px-3">
    ...
    <div class="d-none d-print-block">
        <table class="header-table">
            <tr>
                ...
                <td class="title" style="border-left: none !important; text-align: center;">
                    <div style="font-size: 16px;">REKAP HARIAN VERIFICATION DOUBLE TAPE</div>
                </td>
            </tr>
        </table>
        <div class="sub-header">
            ...
            @if(request('operator_initials'))
                &nbsp;&nbsp;|&nbsp;&nbsp;
                <strong>Inisial Inspector:</strong> {{ strtoupper(request('operator_initials')) }}
            @endif
        </div>
    </div>
    ...
    <div class="card shadow-sm mb-4 border-0 rounded-lg overflow-hidden custom-filter-card no-print">
        <div class="card-body py-2">
            <form action="{{ route('double_tape.daily_recap') }}" method="GET" class="row align-items-center">
                ...
                <div class="col-md-auto mb-2 mb-md-0 d-flex align-items-center ml-md-3">
                    ...
                    <select name="operator_initials" class="form-control form-control-sm shadow-sm" style="width: 110px;">
                        <option value="">Semua</option>
                ...
                <div class="col-md-auto">
                    ...
                    <a href="{{ route('double_tape.daily_recap') }}" class="btn btn-light btn-sm shadow-sm rounded-pill px-3 border ml-1">
