                    ...
                    <table class="table table-bordered" id="checksheetTable" width="100%" cellspacing="0">
                        <thead class="bg-light text-center small font-weight-bold">
                            <tr>
                                ...
                                <th colspan="3">Quantity Details</th>
                            ...
                            <tr>
                                ...
                                <td>
                                    <input type="number" step="any" class="form-control text-center"
                                        name="komper_jirigen_kg" id="komperJirigenInput" placeholder="0" required style="min-width: 120px;">
                                </td>
                                <td>
                                    <input type="number" step="any" class="form-control text-center"
                                        name="sampling_size_jirigen_kg" id="totalCheckInput" placeholder="0" required style="min-width: 120px;">
                                </td>
