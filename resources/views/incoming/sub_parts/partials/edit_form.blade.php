<form action="{{ route('incoming.sub_parts.update', $checksheet->id) }}" method="POST" id="editChecksheetForm">
    @csrf @method('PUT')
    <div class="row">
        <div class="col-md-6 form-group">
            <label class="font-weight-bold">Sub-Part Name</label>
    ...
    <div class="row">
        ...
        <div class="col-md-4 form-group">
            <label class="font-weight-bold">Quantity (Pcs)</label>
            <input type="number" class="form-control" name="quantity" value="{{ $checksheet->quantity }}" required>
        </div>
        <div class="col-md-4 form-group">
            <label class="font-weight-bold">Sampling (Pcs)</label>
            <input type="number" class="form-control" name="sampling_size_pcs"
                value="{{ $checksheet->sampling_size_pcs }}" required>
        </div>
    </div>
    <div class="row">
        <div class="col-md-4 form-group">
