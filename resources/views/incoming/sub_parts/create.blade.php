                    ...
                    <table class="table table-bordered" id="checksheetTable" width="100%" cellspacing="0">
                        <thead class="bg-light text-center small font-weight-bold">
                            <tr>
                                ...
                                <th colspan="2">Quantity Details</th>
                                <th rowspan="2" style="min-width: 250px;">Check Dimensi</th>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td><input type="text" class="form-control" name="lot_batch_number" placeholder="Lot #" required></td>
                                <td><input type="number" step="any" class="form-control text-center" name="quantity" id="lotQtyInput" placeholder="0" required style="min-width: 120px;"></td>
                                <td><input type="number" step="any" class="form-control text-center" name="sampling_size_pcs" id="totalCheckInput" placeholder="0" required style="min-width: 120px;"></td>
                                
                                <td class="align-middle">
                                    <div class="table-responsive" style="max-height: 200px; overflow-y: auto;">
                                        <table class="table table-bordered table-sm mb-0" id="dimensionTable">
                                ...
                                <td><textarea class="form-control" name="remarks" rows="2" placeholder="..."></textarea></td>
                            </tr>
                        </tbody>
                    </table>
                </div>
