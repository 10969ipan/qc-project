...
@php
    ...
    $docHeader = \App\Models\GeneralSetting::getDocHeader('incoming_materials', $headerPlantCode, [
...
<head>
    <meta charset="UTF-8">
    <title>Laporan Checksheet Incoming Material</title>
    <style>
        @page {
            size: A4 landscape;
            margin: 0;
...
<body>
    ...
    <table class="header-table">
        <tr>
            ...
            <td class="title">LAPORAN DATA CHECKSHEET INCOMING MATERIAL</td>
            <td class="doc-info">
                <table>
    ...
    <div class="sub-header">
        @if(!empty($selectedItem))
            <strong>Material Name:</strong> {{ $selectedItem->name }}
        @else
    ...
    <table class="table">
        <thead>
            <tr>
                ...
                <th rowspan="2">MATERIAL NAME / SUPPLIER</th>
