                ...
                <div class="table-responsive">
                    <table class="table table-bordered" id="checksheetTable" width="100%" cellspacing="0">
                        <tr class="text-center">
                            ...
                            <th rowspan="2" class="align-middle col-berat-part" style="display: none;min-width: 160px;">Berat Part</th>
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td class="align-middle col-berat-part" style="display: none; min-width: 160px;">
                                        <div class="form-group mb-0">
                                            {{-- Cavity controls --}}
                                            <div class="text-center mb-1">
                                                <button type="button" id="addWeightCavBtn" class="btn btn-primary btn-sm mr-1"
                                                    title="Tambah Cavity Berat">
                                                    <i class="fas fa-plus"></i> Cav
                                                </button>
                                                <button type="button" id="removeWeightCavBtn"
                                                    class="btn btn-outline-danger btn-sm" title="Hapus Cavity Terakhir">
                                                    <i class="fas fa-minus"></i>
                                                </button>
                                            </div>
                                            <div class="text-center mb-1">
                                                <span id="weightCavCount" class="badge badge-secondary">1 Cav</span>
                                            </div>
                                            {{-- Per-cavity rows --}}
            ...
            document.addEventListener('DOMContentLoaded', function ()           {
                ...
                function buildWeightCavRow(cavNum) {
                    return '<div class="input-group input-group-sm mb-1 weight-cav-row">' +
                        ...
                        '</div>' +
                        '<input type="number" step="0.01" min="0" class="form-control text-center" name="part_weight[]" placeholder="0.00">' +
