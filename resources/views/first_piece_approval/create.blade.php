                ...
                <div class="table-responsive">
                    <table class="table table-bordered" id="checksheetTable" width="100%" cellspacing="0">
                        <tr class="text-center">
                            ...
                            <th rowspan="2" class="align-middle col-berat-part" style="display: none;min-width: 160px;">
                                Berat Part</th>
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="align-middle col-berat-part" style="display: none; min-width: 170px;">
                                    <div class="px-1">
                                        {{-- ADD / REMOVE buttons --}}
                                        <div class="d-flex align-items-center justify-content-between mb-1">
                                            <span id="weightCavCount" class="badge badge-info" style="font-size:0.8rem;">1
                                                Cav</span>
                                            <div>
                                                <button type="button" id="addWeightCavBtn"
                                                    class="btn btn-primary btn-sm py-0 px-1" style="font-size:0.75rem;"
                                                    title="Tambah Cavity">
                                                    <i class="fas fa-plus"></i> Cav
                                                </button>
                                                <button type="button" id="removeWeightCavBtn"
                                                    class="btn btn-outline-danger btn-sm py-0 px-1"
                                                    style="font-size:0.75rem;" title="Hapus Cavity Terakhir">
                                        ...
                                        <div class="mt-1 text-center">
                                            <span class="badge badge-secondary small" id="weightStandardBadge"
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function updateJudgment() {
                ...
                var isDimensiInvalid = $('.dimension-input.is-invalid').length > 0;
                ...
                if (ng > 0 || sampling > 0 || isDimensiInvalid) { // Only judge if there is data
                    if (isDimensiInvalid || ng >= limits.rej) {
                        ...
                        // NOTE: autoAddDimensionDefect is now handled independently at the top
                        ...
                        // NOTE: autoRemoveDimensionDefect is now handled independently at the top
                    } else {
            ...
            // ============================================================
            // WEIGHT CAVITY HELPERS - defined here so always available
            // ============================================================
            var MAX_WEIGHT_CAV = 8;

            function buildWeightCavRow(cavNum) {
                return '<div class="weight-cav-row" style="display:flex; align-items:center; margin-bottom:4px; gap:4px;">' +
                    '<span style="font-size:0.7rem; font-weight:600; color:#555; white-space:nowrap; min-width:32px;">C' + cavNum + '</span>' +
                    '<input type="number" step="0.01" min="0" class="form-control form-control-sm text-center" name="part_weight[]" placeholder="0.00" style="min-width:0; flex:1;">' +
        ...
        function updateWeightCavBadge() {
                ...
                function initWeightCavities(count) {
                    count = Math.min(Math.max(1, parseInt(count) || 1), MAX_WEIGHT_CAV);
