...
@section('title', 'Laporan Data Checksheet First Piece Approval')
...
@push('scripts')
    ...
    <script>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            if (liveSearchInput) {
                ...
                liveSearchInput.addEventListener('keyup', function () {
                    ...
                    searchTimeout = setTimeout(function () {
                        ...
                        window.location.href = '{{ route('first_piece_approval.index') }}?' + params.toString();
                    }, 500);
                });
            }
            ...
            doc.save('Laporan_Checksheet_First_Piece_Approval_' + new Date().toISOString().slice(0, 10) + '.pdf');
        });
