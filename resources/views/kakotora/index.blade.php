                                ...
                                <tbody>
                                    @foreach ($kakotoras as $item)
                                        <tr>
                                            ...
                                            <td>{{ $item->section ?? '-' }}</td>
                                            <td>{{ Str::limit($item->problem, 50) }}</td>
                                            <td>{{ $item->process ?? '-' }}</td>
                                            <td>{{ Str::limit($item->cause, 50) }}</td>
                                            <td>{{ Str::limit($item->countermeasure, 50) }}</td>
                                            <td>{{ $item->pic ?? '-' }}</td>
                                            <td>{{ $item->supplier ?? '-' }}</td>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" name="similar_part" class="form-control form-control-sm"
                                        ...
                                        <div class="form-group">
                                            ...
                                            <textarea name="countermeasure" class="form-control form-control-sm" rows="2"
                            ...
                            <div class="modal-body text-left">
                                <div class="row">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label class="small font-weight-bold">SIMILAR PART</label>
                                            <input type="text" name="similar_part" id="edit_similar_part"
                                                class="form-control form-control-sm">
                                        </div>
                                        <div class="form-group">
                                            <label class="small font-weight-bold">SECTION</label>
