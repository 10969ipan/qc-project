...
<div class="container-fluid pb-5">
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800 font-weight-bold">Edit Data KAKOTORA ({{ ucfirst(strtolower($plant)) }})</h1>
                ...
                <div class="minimalist-body">
                    ...
                    <form action="{{ route('kakotora.update', $kakotora->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="date" name="date" class="form-control custom-input" value="{{ $kakotora->date }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-3 text-sm-right custom-label">No Registrasi</label>
                            <div class="col-sm-8">
                                <input type="text" name="no_reg" class="form-control custom-input" value="{{ $kakotora->no_reg }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-3 text-sm-right custom-label">Issue Date</label>
                            <div class="col-sm-8">
                                <input type="date" name="issue_date" class="form-control custom-input" value="{{ $kakotora->issue_date }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-3 text-sm-right custom-label">No. Revmodel</label>
                            <div class="col-sm-8">
                                <input type="text" name="rev_model" class="form-control custom-input" value="{{ $kakotora->rev_model }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <select name="category_claim" class="form-control custom-input">
                                    ...
                                    <option value="External" {{ $kakotora->category_claim == 'External' ? 'selected' : '' }}>External</option>
                                    <option value="Internal" {{ $kakotora->category_claim == 'Internal' ? 'selected' : '' }}>Internal</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <input type="text" name="model" class="form-control custom-input" value="{{ $kakotora->model }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-3 text-sm-right custom-label">Part No.</label>
                            <div class="col-sm-8">
                                <input type="text" name="part_number" class="form-control custom-input" value="{{ $kakotora->part_number }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-3 text-sm-right custom-label">Part Name</label>
                            <div class="col-sm-8">
                                <input type="text" name="part_name" class="form-control custom-input" value="{{ $kakotora->part_name }}">
                            </div>
                        </div>
                        <div class="form-group row" style="align-items: flex-start;">
                            ...
                            <div class="col-sm-8">
                                <textarea name="similar_part" class="form-control custom-input" rows="2">{{ $kakotora->similar_part }}</textarea>
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-3 text-sm-right custom-label">Mould</label>
                            <div class="col-sm-8">
                                <input type="text" name="mould" class="form-control custom-input" value="{{ $kakotora->mould }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-3 text-sm-right custom-label">Owner of Mould</label>
                            <div class="col-sm-8">
                                <input type="text" name="owner_mould" class="form-control custom-input" value="{{ $kakotora->owner_mould }}">
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4 mb-2 mb-sm-0">
                                <input type="text" name="section" class="form-control custom-input" value="{{ $kakotora->section }}">
                            </div>
                            <div class="col-sm-4">
                                <input type="text" name="process" class="form-control custom-input" value="{{ $kakotora->process }}">
                            </div>
                        </div>
                        <div class="form-group row" style="align-items: flex-start;">
                            <label class="col-sm-3 text-sm-right custom-label mt-2">Problem</label>
                            <div class="col-sm-8">
                                <textarea name="problem" class="form-control custom-input" rows="3">{{ $kakotora->problem }}</textarea>
                            </div>
                        </div>
                        <div class="form-group row" style="align-items: flex-start;">
                            <label class="col-sm-3 text-sm-right custom-label mt-2">Cause</label>
                            <div class="col-sm-8">
                                <textarea name="cause" class="form-control custom-input" rows="3">{{ $kakotora->cause }}</textarea>
                            </div>
                        </div>
                        <div class="form-group row" style="align-items: flex-start;">
                            <label class="col-sm-3 text-sm-right custom-label mt-2">Countermeasure</label>
                            <div class="col-sm-8">
                                <textarea name="countermeasure" class="form-control custom-input" rows="4">{{ $kakotora->countermeasure }}</textarea>
                            </div>
                        </div>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-4 mb-2 mb-sm-0">
                                <input type="text" name="pic" class="form-control custom-input" value="{{ $kakotora->pic }}">
                            </div>
                            <div class="col-sm-4">
                                <input type="text" name="supplier" class="form-control custom-input" value="{{ $kakotora->supplier }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            <label class="col-sm-3 text-sm-right custom-label">Kategori Defect</label>
                            <div class="col-sm-8">
                                <input type="text" name="defect_category" class="form-control custom-input" value="{{ $kakotora->defect_category }}">
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-8">
                                <select name="status" class="form-control custom-input">
                                    ...
                                    <option value="Closed" {{ $kakotora->status == 'Closed' ? 'selected' : '' }}>Closed</option>
                                    <option value="On Progress" {{ $kakotora->status == 'On Progress' ? 'selected' : '' }}>On Progress</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row" style="align-items: flex-start;">
                            ...
                            <div class="col-sm-8">
                                <textarea name="remarks" class="form-control custom-input" rows="2">{{ $kakotora->remarks }}</textarea>
                            </div>
                        </div>
                        <div class="form-group row" style="align-items: flex-start;">
                            <label class="col-sm-3 text-sm-right custom-label mt-2">Form Analysis</label>
                            <div class="col-sm-8">
                                    ...
                                    <div class="mb-3 p-3 bg-light rounded" style="border: 1px dashed #cbd5e1;">
                                        <div class="d-flex align-items-center justify-content-between">
                                            <div class="d-flex align-items-center text-primary font-weight-bold" style="font-size: 0.85rem;">
                                                <i class="fas fa-file-alt fa-lg mr-2"></i> File Saat Ini
                                            </div>
                                            <a href="{{ $kakotora->form_analysis_url }}" target="_blank" class="btn btn-sm btn-primary btn-minimalist shadow-sm">
                                ...
                                <div class="custom-file mb-1">
                                    ...
                                    <label class="custom-file-label custom-input" for="customFile" id="file-label" style="color: #94a3b8; line-height: 1.5;">@if($kakotora->form_analysis_path) Ganti file (PICA/AR/SA)... @else Pilih file (PICA/AR/SA)... @endif</label>
                                </div>
