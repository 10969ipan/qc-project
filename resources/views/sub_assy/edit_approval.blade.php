    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form action="{{ route('admin.checksheets.update_approval', $checksheet->id) }}" method="POST">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <p><strong>Tanggal:</strong> {{ $checksheet->date }}</p>
                ...
                <div class="row">
                    ...
                    <div class="form-group">
                        ...
                        <select name="kashift_qc" id="kashift_qc" class="form-control">
                            ...
                            <option value="Rejected" @if($checksheet->kashift_qc === 'REJECTED') selected @endif>Rejected
                            </option>
                        </select>
                    </div>
                    ...
                    <div class="form-group col-md-3">
                        ...
                        <select name="asst_manager_qc" id="asst_manager_qc" class="form-control">
                            <option value="Pending" @if(is_null($checksheet->asst_manager_qc)) selected @endif>Pending
                            </option>
