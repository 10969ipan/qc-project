                ...
                <div class="col-md-6">
                    ...
                    <div id="similarPdfContainer" class="rounded border"
                        ...
                        <div id="similarPdfPlaceholder"
                            ...
                            <p class="mb-0">Pilih Item untuk menampilkan Similar/Dimensi Part</p>
    ...
    <script>
        document.addEventListener('DOMContentLoaded', function () {
            ...
            function loadPdf(itemId, index) {
                ...
                if (index === 'similar') {
                    document.getElementById('pdfInfo').textContent = 'Similar/Dimensi Part PDF';
            ...
            function updateJudgment() {
                ...
                // Proactively remove 'Dimensi' defect if measurements are actually OK
                // This ensures 'ng' count drops so judgment can correctly return to OK
                if (!isDimensiInvalid) {
                    ...
                    if (hasDimensiDefect) {
                        ...
                        return; // autoRemove will trigger calculateTotalNG -> updateJudgment again
                    }
                }
            ...
            $('#itemSelect').change(function () {
                ...
                if (similarPdf) {
                    ...
                    $('#similarStatusText').text('Referral Similar/Dimensi Part tidak tersedia untuk item ini');
            ...
            function resetState() {
                ...
                $('#similarPdfPlaceholder').show().find('p').text('Pilih Item untuk menampilkan Similar/Dimensi Part');
                $('#similarStatusText').text('');
