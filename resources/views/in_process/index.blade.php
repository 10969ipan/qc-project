            ...
            doc.autoTable({
                ...
                body: [
                    [
                        ...
                        { content: 'No. Dokumen', styles: { halign: 'left', valign: 'middle', fontSize: 5 } },
                        { content: 'QC-KRW-F-0004', styles: { halign: 'left', valign: 'middle', fontSize: 5 } }
                    ],
                    [
                        { content: 'Tgl. Terbit', styles: { halign: 'left', valign: 'middle', fontSize: 5 } },
                        { content: '25/09/2015', styles: { halign: 'left', valign: 'middle', fontSize: 5 } }
                    ],
                    [
                        { content: 'Revisi Ke', styles: { halign: 'left', valign: 'middle', fontSize: 5 } },
                        { content: '3', styles: { halign: 'left', valign: 'middle', fontSize: 5 } }
                    ],
                    [
                        { content: 'Tgl. Revisi', styles: { halign: 'left', valign: 'middle', fontSize: 5 } },
                        { content: '30/09/2020', styles: { halign: 'left', valign: 'middle', fontSize: 5 } }
                    ]
                ],
                theme: 'grid',
                styles: {
